...
def classify_product(name):
    ...
    # [추가] 애매하거나 특정 분류에 속하지 않는 상품들을 '기타'로 우선 분류
    # '홍삼', '숙취' 관련 키워드도 여기에 포함
    misc_keywords = [
        '홍삼', '숙취', '컨디션', '여명', '상쾌환', '종근당','종건','정관장', '스틱', '비타C구미오렌지7입', '순수한면','비비안','순면',
        '멀티비타', '용기', '세트', '키트', '재료', '소스', '양념', '찌개용',
        '즉석', '조리', '구이', '녹차녹차돌자반'
        '증정', '사은품', '포인트' 
    ]
    ...
    household = [
        ...
        '샤프란', '바디피트', '좋은느낌', '디어스킨', '칫솔', '치약', '비누', '순한면',
    ...
    snack = [
        ...
        '후라보노', '풍선껌', '마쉬멜로우', '짱셔요', '츄파춥스', '목캔디', '젤리빈', '텐텐', '박하사탕',

        # 3. 초콜릿류 ('초코' 단독 사용 시 초코우유가 끌려오므로 구체화)
        '초콜릿', '초콜렛', '초코바', '초코파이', '가나', '허쉬', '킨더', '페레로로쉐', '킷캣',
        '엠앤엠즈', '트윅스', '스니커즈', '크런키', '자유시간', '핫브레이크', '브라우니', '투익스',
